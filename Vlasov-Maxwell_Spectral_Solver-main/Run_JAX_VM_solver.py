...
#Save the JSON parameters into a txt Using double backslashes

"""
Optionally, you can save your parameters into another file, would recommend creating a "WriteParams" file
"""
#with open('WriteParams\\Parameters_Landau_Damping_write_1D.txt', 'w') as file:
